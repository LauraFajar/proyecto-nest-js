...
import { View, Text, TextInput, Pressable, StyleSheet, Modal, ScrollView, ActivityIndicator, Switch, KeyboardAvoidingView, Platform, Dimensions } from 'react-native';
...
export default function LotFormModal({ visible, onClose, onSubmit, lot, loading }) {
  ...
  const cardWidth = Math.min(380, Math.round(width * 0.95));
  const cardMaxHeight = Math.min(520, Math.round(height * 0.85));
  return (
