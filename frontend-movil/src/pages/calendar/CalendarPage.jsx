...
export default function CalendarPage() {
  ...
  const fetchMonthEvents = async (dateObj) => {
    ...
    try {
      ...
      const list = await calendarService.getCalendarEvents(startEnd.start, startEnd.end, filters.id_cultivo || undefined);
      setEvents(list);
    } catch (e) {
  ...
  useEffect(() => { fetchMonthEvents(currentMonth); }, [currentMonth, filters.fecha_desde, filters.fecha_hasta, filters.id_cultivo]);
